   ...
   */
   ...
   void InitDefinedFormation() {
      ...
      std::vector<CVector3> dec_pos = {
         CVector3(-5.650, -7.000, 1.500),
         CVector3(-5.741, -6.512, 1.500),
         CVector3(-6.002, -6.091, 1.500),
         CVector3(-6.398, -5.792, 1.500),
         CVector3(-6.875, -5.656, 1.500),
         CVector3(-7.369, -5.702, 1.500),
         CVector3(-7.814, -5.923, 1.500),
         CVector3(-8.148, -6.289, 1.500),
         CVector3(-8.327, -6.752, 1.500),
         CVector3(-8.327, -7.248, 1.500),
         CVector3(-8.148, -7.711, 1.500),
         CVector3(-7.814, -8.077, 1.500),
         CVector3(-7.369, -8.298, 1.500),
         CVector3(-6.875, -8.344, 1.500),
         CVector3(-6.398, -8.208, 1.500),
         CVector3(-6.002, -7.909, 1.500),
         CVector3(-5.741, -7.488, 1.500),
      };
      int i = 0;
      for(auto& a : agents) {
