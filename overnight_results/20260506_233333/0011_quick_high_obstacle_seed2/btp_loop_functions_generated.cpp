...
public:
   ...
   */
   ...
   void InitObstacles() {
      ...
      obstacles.push_back({"bld_6",  CVector3(-6.800, 3.800, 1.200), CVector3(0.600, 0.600, 1.200), false});
      obstacles.push_back({"bld_7",  CVector3(0.200, 4.700, 1.400), CVector3(0.650, 0.600, 1.400), false});
      obstacles.push_back({"bld_8",  CVector3(5.800, 0.800, 1.300), CVector3(0.600, 0.700, 1.300), false});
      obstacles.push_back({"bld_9",  CVector3(1.000, -6.200, 1.100), CVector3(0.600, 0.600, 1.100), false});
   ...
   void InitWaypoints() {
      waypoints.clear();
      /* Generated waypoint mode: wide_left */
      waypoints.push_back(CVector3(-7.000, -7.000, 1.500));
      waypoints.push_back(CVector3(-7.000, -3.000, 1.500));
      waypoints.push_back(CVector3(-5.800, 0.500, 1.500));
