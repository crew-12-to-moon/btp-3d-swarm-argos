...
public:
   ...
   */
   ...
   void InitObstacles() {
      ...
      obstacles.push_back({"bld_6",  CVector3(-0.800, 2.700, 1.300), CVector3(0.700, 0.600, 1.300), false});
      obstacles.push_back({"bld_7",  CVector3(1.300, 2.600, 1.300), CVector3(0.700, 0.600, 1.300), false});
   ...
   void InitWaypoints() {
      waypoints.clear();
      /* Generated waypoint mode: choke */
      waypoints.push_back(CVector3(-7.000, -7.000, 1.500));
      waypoints.push_back(CVector3(-4.500, -4.200, 1.500));
      waypoints.push_back(CVector3(-2.000, -1.000, 1.500));
      waypoints.push_back(CVector3(0.000, 1.000, 1.500));
